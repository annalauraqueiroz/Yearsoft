...
public class CadastroUsuario extends javax.swing.JFrame {
    ...
    public CadastroUsuario() {
        ...
        btnCadastrar.setSize(panelLogin.getSize());
    ...
    public void abrirCadastro(TelaInicial telaInicial){
    ...
    public void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt){
        ...
        if(nome.equals("") || login.equals("") || senha.equals("")){
            ...
            if(controleUsuario.cadastrar(usuario)){
                JOptionPane.showMessageDialog(null,"Usuário(a) "+usuario.getNome()+" cadastrado(a) com sucesso!");
